...
class handDetector():
    def __init__(self, image_mode= False, max_num_hands =3, modelComplexity=1, min_detection_confidence =0.5, min_tracking_confidence =0.5):
        ...
        self.hands = self.mphands.Hands(self.image_mode, self.max_num_hands, self.modelComplex, self.min_detection_confidence, self.min_tracking_confidence)
